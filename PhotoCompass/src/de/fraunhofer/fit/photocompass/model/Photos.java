...
public final class Photos {
    ...
    public void updatePhotos(final Activity activity) {
	    ...
	    int idCol, imgCol, latCol, lngCol, dateCol, thumbCol;
	    int id; double alt, lat, lng; String date, img, thumb;//thumb contains the file raw path 
...
//TODO CHECK IF imgCol is a directory with all the files or just the WHOLE PATH of 1 PHOTO
