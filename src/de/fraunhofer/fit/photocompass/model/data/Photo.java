...
//        _alt = alt;
     ...
     * 
     * @return {@link MediaStore.Images.Thumbnails#IMAGE_ID} of the photo (if MediaStore photo), or the resource id of
     ...
     * 
     * @return <code>true</code> if it's a dummy photo (use resourceId to access it), or, <code>false</code> if it's a
