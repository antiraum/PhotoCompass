...
public class Photos {
	...
	protected Photos() {
	    ...
	    // dummy Photos (stuff near B-IT) altitude 
	    _photos.add(new Photo(R.drawable.photo_0518, Location.convert("50:43:11.4"), Location.convert("7:7:18"),5));
	    _photos.add(new Photo(R.drawable.photo_0519, Location.convert("50:43:10.8"), Location.convert("7:7:18.6"),20));
	    _photos.add(new Photo(R.drawable.photo_0520, Location.convert("50:43:12"), Location.convert("7:7:19.2"), 32));
	    _photos.add(new Photo(R.drawable.photo_0521, Location.convert("50:43:10.8"), Location.convert("7:7:20.4"),10));
	    _photos.add(new Photo(R.drawable.photo_0522, Location.convert("50:43:10.8"), Location.convert("7:7:21"),14));
	    _photos.add(new Photo(R.drawable.photo_0523, Location.convert("50:43:10.8"), Location.convert("7:7:21.6"),36));
	    _photos.add(new Photo(R.drawable.photo_0524, Location.convert("50:43:10.21"), Location.convert("7:7:22.8"),3));
	    _photos.add(new Photo(R.drawable.photo_0525, Location.convert("50:43:10.21"), Location.convert("7:7:22.8"),2));
     ...
     */
    public List<Photo> getPhotos(double alt, double lat, double lng, float yaw, float maxDistance, int minAge, int maxAge) {
//    	Log.d(PhotoCompassApplication.LOG_TAG, "Photos: getPhotos");
    	...
    	for (Photo photo : _photos) {
    		...
    		photo.updateDistanceAndDirection(lat, lng, alt);
