...
/**
 * Callback interface for DoubleSeekBar subclasses. Each {@link DoubleSeekBar} has one IDoubleSeekBarCallback to notify
 * the model about changes as well as to get the actual minimum and maximum value.<br>
 * <strong>Important:</strong> The DoubleSeekBar will not display any changes if the callback does not invoke, somehow,
 * the {@link DoubleSeekBar#updateStartValue(float)} or {@link DoubleSeekBar#updateEndValue(float)} method.
 */
public interface IDoubleSeekBarCallback {
    
    /**
     * Called by the {@link DoubleSeekBar} to announce updates of the slider for the minimum value. The update, however,
     * will not be displayed automatically. Therefore, the implementation of this method needs to make sure that the
     * {@link DoubleSeekBar#updateStartValue(float)} is called somehow. The purpose of this method is, therefore, to
     * update a model with the new value, which may apply constraints to the value before updating the
     * {@link DoubleSeekBar}'s view.
     * 
     * @param newValue the new relative minimum value of the range [0,1[ (always smaller than the current maximum value)
     */
     ...
     * will not be displayed automatically. Therefore, the implementation of this method needs to make sure that the
     * {@link DoubleSeekBar#updateEndValue(float)} is called somehow. The purpose of this method is, therefore, to
     * update a model with the new value, which may apply constraints to the value before updating the
     * {@link DoubleSeekBar}'s view.
     * 
     * @param newValue the new relative maximum value of the range ]0,1] (always greater than the current minimum value)
     */
