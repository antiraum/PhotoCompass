...
public final class CompassLineView extends View {
    ...
    private final int AVAILABLE_WIDTH;
     ...
     * @param centerHeight Y-Position of the compass line.
     */
    public CompassLineView(final Context context, final int availableWidth, final int centerHeight) {
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        for (int i = 0; i < numPositions; i++) {
            ...
            canvas.drawLine(dirPos, CENTER_HEIGHT - CompassView.POSITION_MARKER_HALFHEIGHT, dirPos,
                            CENTER_HEIGHT + CompassView.POSITION_MARKER_HALFHEIGHT, _paint);
        }
    }
}
