...
/**
 * This view is used by the {@link PhotosView} to display a photo. It shows the photo and an overlaying text with
 * information about the photo.
 */
final class PhotoView extends SimpleAbsoluteLayout {
    
    private final Photo _photo; // Photo object for the displayed photo
...
//    	stringBuilder.append(_photo.getFormattedAltOffset());
     ...
     * 
     * @param value <code>true</code> to minimize the photo, or <code>false</code> to restore the photo.
     */
     ...
     * 
     * @return <code>true</code> when the photo is minimized, or <code>false</code> when the photo is not minimized.
     */
    boolean isMinimized() {
