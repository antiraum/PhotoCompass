...
//	This function is not needed in order to extract the altitude.
...
//    }
    ...
    public static void main(String[] args) throws MetadataException, IOException
    {
        ...
        try {
            metadata = JpegMetadataReader.readMetadata(new File("C:/Workspaces/FIT LAB/EXIFmetadataextractor/data/bike.jpg"));
        } catch (Exception e) {
